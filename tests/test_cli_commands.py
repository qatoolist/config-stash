...
""")
    ...
    def test_validate_then_export_workflow(self):
        ...
        # Then export
        export_result = self.runner.invoke(cli, [
            'export', 'default',
            '--loader', 'yaml:config.yaml',
            '--format', 'json',
            '--output', 'validated_config.json'
        ])
